 ...
 */
class FeatureFlagsEnrichUsageDashboardCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/projects/{$this->projectId}/feature_flags/{$this->id}/enrich_usage_dashboard";
	}
