 ...
 */
class FeatureFlagsCreateStaticCohortForFlagCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/projects/{$this->projectId}/feature_flags/{$this->id}/create_static_cohort_for_flag";
	}
