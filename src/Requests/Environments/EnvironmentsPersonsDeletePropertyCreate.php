 ...
 */
class EnvironmentsPersonsDeletePropertyCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/persons/{$this->id}/delete_property";
	}
