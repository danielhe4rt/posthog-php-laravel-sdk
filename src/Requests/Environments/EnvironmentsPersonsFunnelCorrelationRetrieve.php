...
/**
 * environments_persons_funnel_correlation_retrieve
 *
 ...
 */
class EnvironmentsPersonsFunnelCorrelationRetrieve extends Request
{
	...
	{
		return "/api/environments/{$this->projectId}/persons/funnel/correlation";
	}
