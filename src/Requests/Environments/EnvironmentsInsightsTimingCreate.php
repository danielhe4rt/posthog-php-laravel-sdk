...
/**
 * environments_insights_timing_create
 *
 ...
 */
class EnvironmentsInsightsTimingCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/insights/timing";
	}
