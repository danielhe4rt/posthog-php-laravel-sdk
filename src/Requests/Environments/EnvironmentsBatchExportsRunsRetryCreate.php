 ...
 */
class EnvironmentsBatchExportsRunsRetryCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/batch_exports/{$this->batchExportId}/runs/{$this->id}/retry";
	}
