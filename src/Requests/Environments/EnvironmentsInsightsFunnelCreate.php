...
/**
 * environments_insights_funnel_create
 *
 ...
 */
class EnvironmentsInsightsFunnelCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/insights/funnel";
	}
