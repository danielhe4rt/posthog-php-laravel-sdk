...
/**
 * environments_persons_split_create
 *
 ...
 */
class EnvironmentsPersonsSplitCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/persons/{$this->id}/split";
	}
