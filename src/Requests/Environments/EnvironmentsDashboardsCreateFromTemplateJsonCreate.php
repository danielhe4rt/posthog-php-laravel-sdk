 ...
 */
class EnvironmentsDashboardsCreateFromTemplateJsonCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/dashboards/create_from_template_json";
	}
