 ...
 */
class EnvironmentsDashboardsMoveTilePartialUpdate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/dashboards/{$this->id}/move_tile";
	}
