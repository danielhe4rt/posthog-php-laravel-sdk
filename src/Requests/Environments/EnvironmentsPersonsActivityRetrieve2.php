...
/**
 * environments_persons_activity_retrieve_2
 *
 ...
 */
class EnvironmentsPersonsActivityRetrieve2 extends Request
{
	...
	{
		return "/api/environments/{$this->projectId}/persons/{$this->id}/activity";
	}
