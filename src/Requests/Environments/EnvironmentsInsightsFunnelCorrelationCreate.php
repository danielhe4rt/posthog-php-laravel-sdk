...
/**
 * environments_insights_funnel_correlation_create
 *
 ...
 */
class EnvironmentsInsightsFunnelCorrelationCreate extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/api/environments/{$this->projectId}/insights/funnel/correlation";
	}
