...
/**
 * environments_persons_lifecycle_retrieve
 *
 ...
 */
class EnvironmentsPersonsLifecycleRetrieve extends Request
{
	...
	{
		return "/api/environments/{$this->projectId}/persons/lifecycle";
	}
